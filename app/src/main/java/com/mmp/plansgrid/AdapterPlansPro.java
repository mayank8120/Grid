...
public class AdapterPlansPro extends RecyclerView.Adapter<AdapterPlansPro.ViewHolder> {
    ...
    public AdapterPlansPro(ArrayList<String> listvaluetype, ArrayList<String> timeperiod, ArrayList<String> listamount, Context context) {
